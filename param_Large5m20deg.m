function[p] = param_Large5m20deg()
    p.filename = './LargeTarget5m20deg/adc_data.bin';  
    ...
    p.range = 4.5;              % Radial range of target in meters
    
    p.rBin = 25;                % Manually selected range bin of target
