function[p] = param_4_25m30Right0Up()
    p.filename = './4_25m30Right0Up/adc_data.bin';  
    ...
    %Target information
    p.theta = 30;               % Angle of Arrival
    p.elev = 0;                 % Angle of elevation 
    p.range = 4.25;             % Radial range of target in meters
    
    p.rBin = 27;                % Manually selected range bin of target
